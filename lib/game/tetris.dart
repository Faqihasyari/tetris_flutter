...
class LeftView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isPaused = context.watch<Board>().isPaused;
        ...
        PanelView(
          ...
          child: Column(
            children: [
              ...
              if (!board.isStarted)
                ElevatedButton(
                  onPressed: () => context.read<Board>().startGame(),
                  child: const Text('Start Game'),
                )
              else
                GestureDetector(
                  onTap: () => context.read<Board>().togglePause(),
                  child: Text(isPaused ? 'RESUME' : 'PAUSE'),
                ),
              // ElevatedButton(
              //   onPressed: () => context.read<Board>().togglePause(),
              //   child: Text(isPaused ? 'Resume' : 'Pause'),
              // ),
            ],
          ),
...
class BoardView extends StatelessWidget {
      ...
      switch (tiles[index]) {
        ...
        case Tile.ghost:
          decoration = BoxDecoration(
            color: Colors.black,
            border: Border.all(color: Colors.white, width: _divider),
          );
          break;
      }
  ...
  double voodooTileDimension(BuildContext context) =>
      ([constraints.maxWidth, constraints.maxHeight].reduce(min) -
